...
mainClass in assembly := Some("com.monksy.kafka.wordcountprocessor.WordCountProcessor")
assemblyJarName in assembly := "kafka-streams-scala-wordcountprocessor.jar"

// Some stuff to import in the console
initialCommands in console :=
  """
  // project stuff
  import com.monksy.kafka.wordcountprocessor._
"""